...
class HomeController  extends Controller
{
    ...
    public function bypass_card_payment_save(Request $request, $id){
        ...
        $fake_transaction = Transaction::create(['student_id' => $id, 'amount' => 3000, 'year_id' => Helpers::instance()->getCurrentAccademicYear(), 'tel' => $student->phone??'23700000000', 'status' => 'completed','payment_purpose' => 'ID card','payment_method' => 'bypassed_transaction','reference' => 'bypass124134', 'transaction_id' => 66532, 'payment_id' => -21424, 'financialTransactionId' => 12343, 'is_charges' => 0]);
